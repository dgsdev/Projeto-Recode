...
<head>
    ...
    <title>Projeto Social Squad-8</title>
    <!-- Bootstrap CSS -->
...
<body>
            <!--Começo da tela do video-->
    <div class="video-background">
        <div class="video-wrap">


                <!--Conteudos do meu navbar-->
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                         ...
                         <div id="video" >
                            ...
                            <!--Fim da tela do video-->

                            <!-- inicio do card -->
                <div class="card" style="width: 28rem;">
                    <div class="card-body">
                        <h5 class="card-title text-light"><b>Título do Projeto</b></h5>
